    ...
    <main className="relative min-h-screen overflow-x-hidden bg-[#0F172A] px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4 sm:mb-8">
          ...
          <Link href="/" className="inline-flex min-h-11 items-center gap-2 rounded-xl border border-slate-700 bg-[#111827] px-4 text-sm font-bold text-slate-300 transition hover:bg-[#172033] hover:text-white sm:border-white/10 sm:bg-white/[0.045] sm:hover:bg-white/[0.08]">
            <ArrowLeft size={17} />
            Back to Home
          </Link>
        </div>
        ...
        <div className="grid items-start gap-6 lg:grid-cols-[0.72fr_1.28fr] lg:gap-8">
          <aside className="relative overflow-hidden rounded-3xl border border-slate-700 bg-[#172B63] p-6 shadow-xl sm:rounded-[2rem] sm:border-white/10 sm:bg-gradient-to-br sm:from-[#172B63] sm:via-[#1A2555] sm:to-[#6D3BFF] sm:p-8 sm:shadow-[0_30px_100px_rgba(2,6,23,0.45)] lg:sticky lg:top-8">
            <div aria-hidden="true" className="absolute -right-24 -top-24 hidden h-72 w-72 rounded-full bg-white/10 blur-3xl sm:block" />
            <div aria-hidden="true" className="absolute -bottom-28 -left-20 hidden h-72 w-72 rounded-full bg-[#8C5CFF]/30 blur-3xl sm:block" />
            ...
            <div className="relative">
              ...
              <div className="mt-8 space-y-3">
                {[
                  ...
                  <div key={item} className="flex items-start gap-3 rounded-2xl border border-white/10 bg-[#22366B] p-4 sm:bg-white/10">

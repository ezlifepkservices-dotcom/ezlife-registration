  ...
  return (
    <section id="services" className="relative overflow-hidden bg-[#0F172A] py-20 sm:py-24">
      <div
        ...
        style={{ backgroundImage: "url('/ezlife-services-premium.jpg')" }}
      />
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 leading-7 text-slate-400">
            Members register their interest first. Available packages become visible
            in the member portal after approval.
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {services.map(([title, description, href, Icon, status]) => (
            <Link
              key={title}
              href={href}
              className="group rounded-[1.65rem] border border-white/10 bg-white/[0.045] p-6 backdrop-blur transition hover:-translate-y-2 hover:border-violet-400/40"
            >

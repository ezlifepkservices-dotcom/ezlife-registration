...
export default function ReferralProgramSection() {
  return (
    <section id="referral" className="relative overflow-hidden bg-[#0B1222] py-16 sm:py-20 lg:py-24">
      ...
      <div className="relative mx-auto grid w-full max-w-7xl items-center gap-10 px-5 sm:px-6 lg:grid-cols-[0.92fr_1.08fr] lg:px-8">
        <div className="min-w-0">
          <p className="text-xs font-black uppercase tracking-[0.2em] text-violet-400 sm:text-sm">Referral Program</p>
          <h2 className="mt-4 max-w-2xl text-[clamp(2.25rem,4.2vw,4.25rem)] font-black leading-[1.05] tracking-[-0.035em] text-white">Build your network and unlock more opportunities.</h2>
          <p className="mt-5 max-w-xl text-sm leading-7 text-slate-400 sm:text-base sm:leading-8">Approved referrals are counted against the selected package and remain visible in the member dashboard.</p>
        ...
        <div className="relative min-h-[300px] overflow-hidden rounded-[1.75rem] border border-white/10 sm:min-h-[400px] lg:min-h-[520px]">
          <Image src="/photo-referral.jpg" alt="Referral Program" fill sizes="(max-width:1024px) 100vw,650px" className="object-cover object-center" />

...
export default function AboutSection() {
  return (
    <section id="about" className="relative overflow-hidden bg-[#0B1222] py-14 sm:py-16 lg:py-20">
      ...
      <div className="relative mx-auto grid w-full max-w-[1180px] items-center gap-9 px-5 sm:px-6 lg:grid-cols-[0.92fr_1.08fr] lg:px-8">
        <div className="min-w-0">
          ...
          <p className="mt-4 max-w-[540px] text-sm leading-7 text-slate-400 sm:text-base">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <article className="min-h-[130px] rounded-2xl border border-white/10 bg-white/[0.045] p-4">
              ...
              <p className="mt-1.5 text-xs leading-5 text-slate-400 sm:text-sm">
                To provide members with a simple, transparent and digitally trackable
                path to selected lifestyle opportunities.
              </p>
            </article>
            ...
            <article className="min-h-[130px] rounded-2xl border border-white/10 bg-white/[0.045] p-4">
              ...
              <p className="mt-1.5 text-xs leading-5 text-slate-400 sm:text-sm">
                To become a trusted platform where progress, package rules and service
                access remain clear for every member.
              </p>
            </article>

            <article className="min-h-[110px] rounded-2xl border border-white/10 bg-[#111C35]/70 p-4">
        ...
        <div className="relative min-h-[320px] w-full overflow-hidden rounded-[1.6rem] border border-white/10 sm:min-h-[400px] lg:min-h-[470px]">
          <Image
            src="/photo-about.jpg"

...
const values = [
  {
    ...
    description: "A clear journey built around member progress.",
    icon: UsersRound,
  },
  {
    title: "Fair Process",
    description: "Package rules and eligibility remain visible.",
    icon: Scale,
  },
  {
    title: "Secure & Trusted",
    description: "Member information is protected and verified.",
    icon: ShieldCheck,
  },
  {
    title: "Dedicated Support",
    description: "Members can raise and track support tickets.",
    icon: HeartHandshake,
  },
];
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
        <div>
          ...
          <p className="mt-5 max-w-xl leading-8 text-slate-400">
            ...
            tracking and transparent progress monitoring.
          </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="relative min-h-[300px] overflow-hidden rounded-2xl border border-white/10 sm:col-span-2">
            <Image
              ...
              alt="EZ Life services and opportunities"
              fill

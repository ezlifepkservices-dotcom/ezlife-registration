...
export default function Footer() {
  return (
    <footer id="contact" className="border-t border-white/10 bg-[#08101F] text-white">
      <div className="mx-auto max-w-7xl px-5 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-3">
              <div className="relative h-16 w-16">
                <Image src="/ezlife-logo.png" alt="EZ Life logo" fill sizes="64px" className="object-contain" />
              </div>
              <div>
                <p className="text-2xl font-black">EZ Life</p>
            ...
            <p className="mt-5 max-w-xl leading-7 text-slate-400">
              A digital membership platform connecting approved members with selected
              service packages and a trackable participation journey.
            </p>
          </div>
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-white/10 pt-6 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p>Service availability and package rules are subject to approval and active configuration.</p>
        </div>
      </div>
    </footer>
  );

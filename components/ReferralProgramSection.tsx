...
export default function ReferralProgramSection() {
  return (
    <section id="referral" className="ez-section relative overflow-hidden bg-[#0B1222]">
      ...
      <div className="ez-container ez-grid-2 relative">
        <div className="min-w-0">
          <p className="text-[11px] font-black uppercase tracking-[0.2em] text-violet-400 sm:text-xs">Referral Program</p>
          <h2 className="ez-heading-lg mt-3 max-w-[520px] font-black text-white">Build your network and unlock more opportunities.</h2>
          <p className="ez-body-lg mt-4 max-w-[520px] text-slate-400">Approved referrals are counted against the selected package and remain visible in the member dashboard.</p>
        ...
        <div className="ez-media-frame">
          <Image src="/photo-referral-final.jpg" alt="Referral Program" fill sizes="(max-width: 1024px) 100vw, 610px" className="scale-[1.08] object-cover object-center" />
